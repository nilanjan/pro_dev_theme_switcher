-- Tokyo Night STORM (bg #24283b). Generated from base46 tokyonight (Night, #1a1b26).
...
M.base_30 = {
  ...
  baby_pink = "#DE8C92",
  pink = "#ff75a0",
  line = "#3b4261", -- for lines like vertsplit
  green = "#9ece6a",
...
M = require("base46").override_theme(M, "tokyonight-storm")
